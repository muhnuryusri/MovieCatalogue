...
import com.application.moviecatalogue.data.NetworkBoundResource
...
class FakeCatalogueRepository(
    ...
    companion object {
        ...
        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource, appExecutors: AppExecutors): FakeCatalogueRepository =
                instance ?: synchronized(this) {
                    instance ?: FakeCatalogueRepository(remoteData, localData, appExecutors).apply {
                        instance = this
                    }
                }
    }
